...
function AboutPage() {
  const items = [
    ...
    { id: "0", img: process.env.PUBLIC_URL + "/images-du/imagemAbout.jpg", height: 150 },
    { id: "1", img: process.env.PUBLIC_URL + "/images-du/imagemAbout1.jpg", height: 180 },
    { id: "2", img: process.env.PUBLIC_URL + "/images-du/imagemAbout2.jpg", height: 120 },
    ...
    { id: "9", img: process.env.PUBLIC_URL + "/images-du/imagemAbout9.jpg", height: 110 },
    { id: "10", img: process.env.PUBLIC_URL + "/images-du/imagemAbout10.jpg", height: 150 }
  ];
